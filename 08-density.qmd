...
y <- gaussian_kernel(x)
plot(x, y, type = "l", main = "Gaussian Kernel", xlab = "u", ylab = "K(u)")

## Epanechnikov kernel function
epanechnikov_kernel <- function(u) {
  return(ifelse(abs(u) <= 1, 0.75 * (1 -
 u^2), 0))
}
y_epa <- epanechnikov_kernel(x)
plot(x, y_epa, type = "l", main = "Epanechnikov Kernel", xlab = "u", ylab = "K(u)")

## uniform kernel function
uniform_kernel <- function(u) {
  return(ifelse(abs(u) <= 1, 0.5, 0))
}
y_uni <- uniform_kernel(x)
plot(x, y_uni, type = "l", main = "Uniform Kernel", xlab = "u", ylab = "K(u)")
```
