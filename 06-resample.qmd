...
$$
 Then, we have 
 $$
\alpha/2 = P(L \ge \theta) = P(L-\htt \ge \theta - \htt) = P(\htt - \theta \le \htt - L).
 $$
 
Now, we have to solve it, we need $L-\htt$ be the $1-\alpha/2$'s quantile of the distribution of $\htt - \theta$. However, the distribution of $\htt - \theta$ is *unknown*. In bootstrap, we approximate the distribution of $\htt - \theta$ by the distribution of $\htt^\ast - \htt$. Thus, we set $\htt - L$ to be the $1-\alpha/2$'s quantile of the distribution of $\htt^\ast - \htt$, denoted as $\htt^\ast_{1-\alpha/2}$, that is, $\htt^\ast_{1-\alpha/2}-\htt$. Then, we set $\htt-L$ to be $\htt^\ast_{1-\alpha/2}-\htt$.
