# What is Computational Approaches
...
Notation: $\boldsymbol{X} \sim N_d(\mu, \boldsymbol{\Sigma})$.
...
:::{.callout-tip title = "Take home message 1"}
...
::: {.callout-tip title="Take home message 2"}
