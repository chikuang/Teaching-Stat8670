...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Procedure with inverse transformation method}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Procedure with ITM for discrete case}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Simulate for mixture}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Difference between convolution and mixture}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Performance Comparison}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Mixture of multivariate normal}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Higher dimensional case}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Expectation, Variance and Distribution of theta hat}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\] If \(N_{val}\) is large, we can have good estimate of
\(\mathrm{Err}(f)\).

But actually, we may only have \emph{small} validating set.
...
\item
  Splitting 80-20 may leave too little test data for reliable
  evaluation.
\end{itemize}

What we can do? \textbf{Cross-validation}!

Cross-validation uses \textbf{all} data efficiently for training and
testing.

\section{What is Cross-Validation?}\label{what-is-cross-validation}

Suppose there are 5 folds (\(K=5\)).

\pandocbounded{\includegraphics[keepaspectratio]{fig/yy/Training_ipad2.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig/bias-variance.png}}.

\begin{itemize}
\item
  Bias (Systematic error): The difference between predicted values and
  the true target.
\item
  Variance (Sensitivity to data changes): How much predictions change
  with new data.
\item
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{fig/b-v-tradeoff.pdf}}

}

\caption{Picture borrowed from \footnote{https://djsaunde.wordpress.com/2017/07/17/the-bias-variance-tradeoff/}.}

\end{figure}%

\pandocbounded{\includegraphics[keepaspectratio]{fig/fig2_crop.png}}

With new data \((X,Y)\) from the same distribution:

\pandocbounded{\includegraphics[keepaspectratio]{fig/fig3_crop.png}}

\section{Choice of Fold K}\label{choice-of-fold-k}
...
\begin{itemize}
\item
  Large \(K\): \textbf{high variance}, but \textbf{small bias}.
\item
  Small \(K\): \textbf{low variance}, but \textbf{high bias}.
\end{itemize}

Bias decreases as \(K\) increases.

\section{Example: Stock market}\label{example-stock-market}

We look at the dataset in \textbf{Smarket} package in R.

It contains the daily percentage returns for the S\&P 500 stock index
...
\CommentTok{\# Create the table and scale it to fit the page}
\FunctionTok{head}\NormalTok{(Smarket) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{(}\StringTok{"latex"}\NormalTok{, }\AttributeTok{caption =}\StringTok{" First Few Rows of Smarket Dataset"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{full\_width =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{position =} \StringTok{"center"}\NormalTok{, }\AttributeTok{font\_size =} \DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{fig/yeying/pic5.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{fig/yeying/pic10.png}}

}

\caption{Result of the 5-fold CV with 10 runs.}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(DAAG); }\FunctionTok{attach}\NormalTok{(ironslag)}
\FunctionTok{library}\NormalTok{(ggplot2)}
\FunctionTok{library}\NormalTok{(patchwork)}

\CommentTok{\# {-}{-}{-} raw data {-}{-}{-}}
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(chemical, magnetic)}
\NormalTok{a  }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{40}\NormalTok{, }\FloatTok{0.1}\NormalTok{)}

\CommentTok{\# {-}{-}{-} fits (using coefficients explicitly) {-}{-}{-}}
\NormalTok{L1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(magnetic }\SpecialCharTok{\textasciitilde{}}\NormalTok{ chemical, }\AttributeTok{data =}\NormalTok{ df)}
\NormalTok{yhat1 }\OtherTok{\textless{}{-}}\NormalTok{ L1}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ L1}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ a}

\NormalTok{L2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(magnetic }\SpecialCharTok{\textasciitilde{}}\NormalTok{ chemical }\SpecialCharTok{+} \FunctionTok{I}\NormalTok{(chemical}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{), }\AttributeTok{data =}\NormalTok{ df)}
\NormalTok{yhat2 }\OtherTok{\textless{}{-}}\NormalTok{ L2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ L2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ a }\SpecialCharTok{+}\NormalTok{ L2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ a}\SpecialCharTok{\^{}}\DecValTok{2}

\NormalTok{L3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\FunctionTok{log}\NormalTok{(magnetic) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ chemical, }\AttributeTok{data =}\NormalTok{ df)}
\NormalTok{logyhat3 }\OtherTok{\textless{}{-}}\NormalTok{ L3}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ L3}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ a}
\NormalTok{yhat3 }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(logyhat3)}

\NormalTok{L4 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\FunctionTok{log}\NormalTok{(magnetic) }\SpecialCharTok{\textasciitilde{}} \FunctionTok{log}\NormalTok{(chemical), }\AttributeTok{data =}\NormalTok{ df)}
\NormalTok{logyhat4 }\OtherTok{\textless{}{-}}\NormalTok{ L4}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ L4}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*} \FunctionTok{log}\NormalTok{(a)}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-cv_files/figure-pdf/unnamed-chunk-3-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{attach}\NormalTok{(ironslag)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(magnetic) }\CommentTok{\# in DAAG ironslag}
\NormalTok{e1 }\OtherTok{\textless{}{-}}\NormalTok{ e2 }\OtherTok{\textless{}{-}}\NormalTok{ e3 }\OtherTok{\textless{}{-}}\NormalTok{ e4 }\OtherTok{\textless{}{-}} \FunctionTok{numeric}\NormalTok{(n)}
...
\NormalTok{  y }\OtherTok{\textless{}{-}}\NormalTok{ magnetic[}\SpecialCharTok{{-}}\NormalTok{k]}
\NormalTok{  x }\OtherTok{\textless{}{-}}\NormalTok{ chemical[}\SpecialCharTok{{-}}\NormalTok{k]}
\NormalTok{  J1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x)}
\NormalTok{  yhat1 }\OtherTok{\textless{}{-}}\NormalTok{ J1}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ J1}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ chemical[k]}
\NormalTok{  e1[k] }\OtherTok{\textless{}{-}}\NormalTok{ magnetic[k] }\SpecialCharTok{{-}}\NormalTok{ yhat1}
  
\NormalTok{  J2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x }\SpecialCharTok{+} \FunctionTok{I}\NormalTok{(x}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))}
\NormalTok{  yhat2 }\OtherTok{\textless{}{-}}\NormalTok{ J2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ J2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ chemical[k] }\SpecialCharTok{+}
\NormalTok{    J2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{3}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ chemical[k]}\SpecialCharTok{\^{}}\DecValTok{2}
\NormalTok{  e2[k] }\OtherTok{\textless{}{-}}\NormalTok{ magnetic[k] }\SpecialCharTok{{-}}\NormalTok{ yhat2}
  
\NormalTok{  J3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\FunctionTok{log}\NormalTok{(y) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ x)}
\NormalTok{  logyhat3 }\OtherTok{\textless{}{-}}\NormalTok{ J3}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ J3}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ chemical[k]}
\NormalTok{  yhat3 }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(logyhat3)}
\NormalTok{  e3[k] }\OtherTok{\textless{}{-}}\NormalTok{ magnetic[k] }\SpecialCharTok{{-}}\NormalTok{ yhat3}
  
\NormalTok{  J4 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\FunctionTok{log}\NormalTok{(y) }\SpecialCharTok{\textasciitilde{}} \FunctionTok{log}\NormalTok{(x))}
\NormalTok{  logyhat4 }\OtherTok{\textless{}{-}}\NormalTok{ J4}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+}\NormalTok{ J4}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{*} \FunctionTok{log}\NormalTok{(chemical[k])}
\NormalTok{  yhat4 }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(logyhat4)}
\NormalTok{  e4[k] }\OtherTok{\textless{}{-}}\NormalTok{ magnetic[k] }\SpecialCharTok{{-}}\NormalTok{ yhat4}
\NormalTok{\}}

\CommentTok{\# compute MSEs}
\NormalTok{mse }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{mean}\NormalTok{(e1}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{), }\FunctionTok{mean}\NormalTok{(e2}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{), }\FunctionTok{mean}\NormalTok{(e3}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{), }\FunctionTok{mean}\NormalTok{(e4}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{))}

\CommentTok{\# put into a tidy data frame}
\NormalTok{results }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Model =} \FunctionTok{c}\NormalTok{(}\StringTok{"Linear"}\NormalTok{, }\StringTok{"Quadratic"}\NormalTok{, }\StringTok{"Exponential"}\NormalTok{, }\StringTok{"Log–Log"}\NormalTok{),}
  \AttributeTok{MSE =} \FunctionTok{round}\NormalTok{(mse, }\DecValTok{4}\NormalTok{)}
\NormalTok{)}

\CommentTok{\# display as a clean table}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(results, }
             \AttributeTok{caption =} \StringTok{"Model Comparison of Mean Squared Errors"}\NormalTok{, }\AttributeTok{align =} \FunctionTok{c}\NormalTok{(}\StringTok{"l"}\NormalTok{, }\StringTok{"c"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}lc@{}}
\caption{Model Comparison of Mean Squared Errors}\tabularnewline
\toprule\noalign{}
Model & MSE \\
\midrule\noalign{}
\endfirsthead
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{2}\NormalTok{)) }\CommentTok{\#layout for graphs}
\FunctionTok{plot}\NormalTok{(L2}\SpecialCharTok{$}\NormalTok{fit, L2}\SpecialCharTok{$}\NormalTok{res) }\CommentTok{\#residuals vs fitted values}
\FunctionTok{abline}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{) }\CommentTok{\#reference line}
\FunctionTok{qqnorm}\NormalTok{(L2}\SpecialCharTok{$}\NormalTok{res) }\CommentTok{\#normal probability plot}
\FunctionTok{qqline}\NormalTok{(L2}\SpecialCharTok{$}\NormalTok{res) }\CommentTok{\#reference line}
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\CommentTok{\#restore display}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-cv_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Derivation}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark for estimating se}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(bootstrap) }\CommentTok{\#for the law data}
\FunctionTok{print}\NormalTok{(}\FunctionTok{cor}\NormalTok{(law}\SpecialCharTok{$}\NormalTok{LSAT, law}\SpecialCharTok{$}\NormalTok{GPA))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# [1] 0.7763745}
\FunctionTok{print}\NormalTok{(}\FunctionTok{cor}\NormalTok{(law82}\SpecialCharTok{$}\NormalTok{LSAT, law82}\SpecialCharTok{$}\NormalTok{GPA))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# [1] 0.7599979}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#set up the bootstrap}
\NormalTok{B }\OtherTok{\textless{}{-}} \DecValTok{200} \CommentTok{\#number of replicates}
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(law) }\CommentTok{\#sample size}
\NormalTok{R }\OtherTok{\textless{}{-}} \FunctionTok{numeric}\NormalTok{(B) }\CommentTok{\#storage for replicates}
\CommentTok{\#bootstrap estimate of standard error of R}
\ControlFlowTok{for}\NormalTok{ (b }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{B) \{}
  \CommentTok{\# randomly select the indices}
\NormalTok{  i }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{n, }\AttributeTok{size =}\NormalTok{ n, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  LSAT }\OtherTok{\textless{}{-}}\NormalTok{ law}\SpecialCharTok{$}\NormalTok{LSAT[i] }\CommentTok{\# i is a vector of indices}
\NormalTok{  GPA }\OtherTok{\textless{}{-}}\NormalTok{ law}\SpecialCharTok{$}\NormalTok{GPA[i]}
\NormalTok{  R[b] }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(LSAT, GPA)}
\NormalTok{\}}
\CommentTok{\#output}
\NormalTok{(se.R }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(R))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# [1] 0.1358393}
\FunctionTok{hist}\NormalTok{(R, }\AttributeTok{prob =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{06-resample_files/figure-pdf/unnamed-chunk-2-1.pdf}}

The bootstrap estimate of se(R) is 0.1335692. The normal theory estimate
for standard error of R is 0.115.

We can also use the \texttt{boot(.)} function in the \texttt{boot}
package to compute the bootstrap estimate of standard error.

First, write a function that returns \(\hat \theta(b)\), where the first
argument to the function is the sample data, and the second argument is
the vector \(\{i_1, \dots , i_n\}\) of indices. If the data is \(x\) and
the vector of indices is i, we need \(x[i,1]\) to extract the first
resampled variable, and x{[}i,2{]} to extract the second resampled
variable. The code and output is shown below.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my\_r }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x, i) \{}
  \CommentTok{\# want correlation of columns 1 and 2}
  \FunctionTok{cor}\NormalTok{(x[i, }\DecValTok{1}\NormalTok{], x[i, }\DecValTok{2}\NormalTok{])}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sd}\NormalTok{(obj}\SpecialCharTok{$}\NormalTok{t)}
\end{Highlighting}
\end{Shaded}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Remark for estimating bias}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# sample estimate for n=15}
\NormalTok{theta.hat }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(law}\SpecialCharTok{$}\NormalTok{LSAT, law}\SpecialCharTok{$}\NormalTok{GPA)}
\CommentTok{\# bootstrap estimate of bias}
\NormalTok{B }\OtherTok{\textless{}{-}} \DecValTok{2000} \CommentTok{\# larger for estimating bias}
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(law)}
\NormalTok{theta.b }\OtherTok{\textless{}{-}} \FunctionTok{numeric}\NormalTok{(B)}
\ControlFlowTok{for}\NormalTok{ (b }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{B) \{}
\NormalTok{  i }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{n, }\AttributeTok{size =}\NormalTok{ n, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  LSAT }\OtherTok{\textless{}{-}}\NormalTok{ law}\SpecialCharTok{$}\NormalTok{LSAT[i]}
\NormalTok{  GPA }\OtherTok{\textless{}{-}}\NormalTok{ law}\SpecialCharTok{$}\NormalTok{GPA[i]}
\NormalTok{  theta.b[b] }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(LSAT, GPA)}
\NormalTok{\}}
\NormalTok{bias }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(theta.b }\SpecialCharTok{{-}}\NormalTok{ theta.hat)}
\NormalTok{bias}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{head}\NormalTok{(patch)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(patch) }\CommentTok{\#in bootstrap package}
\NormalTok{B }\OtherTok{\textless{}{-}} \DecValTok{2000}
\NormalTok{theta.b }\OtherTok{\textless{}{-}} \FunctionTok{numeric}\NormalTok{(B)}
\NormalTok{theta.hat }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(patch}\SpecialCharTok{$}\NormalTok{y) }\SpecialCharTok{/} \FunctionTok{mean}\NormalTok{(patch}\SpecialCharTok{$}\NormalTok{z)}

\ControlFlowTok{for}\NormalTok{ (b }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{B) \{}
\NormalTok{  i }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{n, }\AttributeTok{size =}\NormalTok{ n, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{  y }\OtherTok{\textless{}{-}}\NormalTok{ patch}\SpecialCharTok{$}\NormalTok{y[i]}
\NormalTok{  z }\OtherTok{\textless{}{-}}\NormalTok{ patch}\SpecialCharTok{$}\NormalTok{z[i]}
\NormalTok{  theta.b[b] }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(y) }\SpecialCharTok{/} \FunctionTok{mean}\NormalTok{(z)}
\NormalTok{\}}
\NormalTok{bias }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(theta.b) }\SpecialCharTok{{-}}\NormalTok{ theta.hat}
\NormalTok{se }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(theta.b)}
\NormalTok{result }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Estimate =}\NormalTok{ theta.hat,}
  \AttributeTok{Bias =}\NormalTok{ bias,}
  \AttributeTok{SE =}\NormalTok{ se,}
  \AttributeTok{CV =}\NormalTok{ bias }\SpecialCharTok{/}\NormalTok{ se}
\NormalTok{)}

\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(result, }\AttributeTok{digits =} \DecValTok{3}\NormalTok{, }\AttributeTok{caption =} \StringTok{"Bootstrap results for correlation estimate"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{06-resample_files/figure-pdf/bootstrap-simple-example-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{06-resample_files/figure-pdf/bootstrap-simple-example-2.pdf}}

The bootstrap is a general tool for assessing statistical accuracy.
First we describe the bootstrap in general, and then show how it can be
used to estimate extra-sample prediction error. As with
cross-validation, the boot- strap seeks to estimate the conditional
error ErrT , but typically estimates well only the expected prediction
error Err.
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Normal theory for SE (will not be on exam)}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, left=2mm, rightrule=.15mm, toptitle=1mm, arc=.35mm, colback=white]
...
✅ \textbf{Normal approximation (Fisher z) SE = 0.115}

Alternatively, we may use the \textbf{Bootstrap Estimate} to compare
with:
...
\NormalTok{law }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{LSAT =} \FunctionTok{c}\NormalTok{(}\DecValTok{576}\NormalTok{, }\DecValTok{635}\NormalTok{, }\DecValTok{558}\NormalTok{, }\DecValTok{578}\NormalTok{, }\DecValTok{666}\NormalTok{, }\DecValTok{580}\NormalTok{, }\DecValTok{555}\NormalTok{, }\DecValTok{661}\NormalTok{, }\DecValTok{651}\NormalTok{, }\DecValTok{605}\NormalTok{, }\DecValTok{653}\NormalTok{, }\DecValTok{575}\NormalTok{, }\DecValTok{545}\NormalTok{, }\DecValTok{572}\NormalTok{, }\DecValTok{594}\NormalTok{),}
  \AttributeTok{GPA  =} \FunctionTok{c}\NormalTok{(}\DecValTok{339}\NormalTok{, }\DecValTok{330}\NormalTok{, }\DecValTok{281}\NormalTok{, }\DecValTok{303}\NormalTok{, }\DecValTok{344}\NormalTok{, }\DecValTok{307}\NormalTok{, }\DecValTok{300}\NormalTok{, }\DecValTok{343}\NormalTok{, }\DecValTok{336}\NormalTok{, }\DecValTok{313}\NormalTok{, }\DecValTok{312}\NormalTok{, }\DecValTok{274}\NormalTok{, }\DecValTok{276}\NormalTok{, }\DecValTok{288}\NormalTok{, }\DecValTok{296}\NormalTok{)}
\NormalTok{)}

\CommentTok{\# Sample correlation}
\NormalTok{r }\OtherTok{\textless{}{-}} \FunctionTok{cor}\NormalTok{(law}\SpecialCharTok{$}\NormalTok{LSAT, law}\SpecialCharTok{$}\NormalTok{GPA)}
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(law)}

\CommentTok{\# Bootstrap estimate of SE}
\NormalTok{B }\OtherTok{\textless{}{-}} \DecValTok{200}
\NormalTok{R }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(B, \{}
\NormalTok{  i }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{n, }\AttributeTok{size =}\NormalTok{ n, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
  \FunctionTok{cor}\NormalTok{(law}\SpecialCharTok{$}\NormalTok{LSAT[i], law}\SpecialCharTok{$}\NormalTok{GPA[i])}
\NormalTok{\})}
\NormalTok{se\_boot }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(R)}

\CommentTok{\# Normal approximation}
\NormalTok{se\_normal }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{((}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ r}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/}\NormalTok{ (n }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{))}
...
10 & Wu, Yunxue & & TBA \\
11 & Jinnah, Kalen & & TBA \\
11 & Krause, Andrew & & TBA \\
\end{longtable}

\section{Format}\label{format}

\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, breakable, colframe=quarto-callout-note-color-frame, toprule=.15mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, left=2mm]
