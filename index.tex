...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Simulate for mixture}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Difference between convolution and mixture}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Performance Comparison}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Mixture of multivariate normal}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Higher dimensional case}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, rightrule=.15mm, bottomtitle=1mm, toptitle=1mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, breakable]
...
Note that \[\frac{1}{m}\sum_{i=1}^m[g(x_i)-\bar{g}(x_i)],\] is the
...
of \(g(X)\) is therefore \((0.977)(1 − 0.977)/10000 =2.223e-06\). The MC
estimate \(2.228e-06\) of variance is quite close to this value.
...
Recall that the sample-mean MC estimator of the integral \(\theta\) is
computed as follows.
...
taken over a \emph{different sample} and therefore this estimator has a
different variance than the one we have above.
...
\section{A minimal R simulation}\label{a-minimal-r-simulation}

We will estimate \(\theta=\mathbb{E}[g(X)]\) with
\(X\sim\mathcal N(0,1)\) and \(g(x)=x^2\). Here, \(\theta=1\) and
\(\mathbb{V}ar(g(X))=\mathbb{V}ar(X^2)=2\).
...
\NormalTok{mc\_once }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(m) \{}
  \CommentTok{\# one replicate of the MC mean based on m i.i.d. Y\_j = g(X\^{}\{(j)\}\_1)}
  \CommentTok{\# (for simplicity, treat each "replicate sample" as size n=1)}
\NormalTok{  x }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(m)}
  \FunctionTok{mean}\NormalTok{(}\FunctionTok{g}\NormalTok{(x))}
\NormalTok{\}}

\NormalTok{Mgrid }\OtherTok{\textless{}{-}} \FunctionTok{as.integer}\NormalTok{(}\DecValTok{10}\SpecialCharTok{\^{}}\FunctionTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{5}\NormalTok{, }\AttributeTok{length.out =} \DecValTok{9}\NormalTok{)) }\CommentTok{\# m from 10 to 1e5 on a log grid}
\NormalTok{R }\OtherTok{\textless{}{-}} \DecValTok{200}                                         \CommentTok{\# repetitions to estimate Monte Carlo variance}

\NormalTok{mc\_means }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(Mgrid, }\ControlFlowTok{function}\NormalTok{(m) }\FunctionTok{replicate}\NormalTok{(R, }\FunctionTok{mc\_once}\NormalTok{(m)))}
\NormalTok{est\_var }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(mc\_means, }\DecValTok{2}\NormalTok{, var)                }\CommentTok{\# empirical Var(\textbackslash{}hat theta)}
\NormalTok{theo\_var }\OtherTok{\textless{}{-}}\NormalTok{ sigma2\_true }\SpecialCharTok{/}\NormalTok{ Mgrid                   }\CommentTok{\# Var(g(X))/m}

\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{m =}\NormalTok{ Mgrid, }\AttributeTok{empirical\_var =}\NormalTok{ est\_var, }\AttributeTok{theory\_var =}\NormalTok{ theo\_var)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Mgrid, est\_var, }\AttributeTok{log =} \StringTok{"xy"}\NormalTok{, }\AttributeTok{type =} \StringTok{"b"}\NormalTok{,}
     \AttributeTok{xlab =} \StringTok{"m (number of replicates, log scale)"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"Var(}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{u005Chat\{}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{u03B8\}) (log scale)"}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(Mgrid, theo\_var, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topright"}\NormalTok{,}
       \AttributeTok{legend =} \FunctionTok{c}\NormalTok{(}\StringTok{"Empirical"}\NormalTok{, }\StringTok{"Theory: Var(g(X))/m"}\NormalTok{),}
       \AttributeTok{lwd =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{), }\AttributeTok{pch =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\ConstantTok{NA}\NormalTok{), }\AttributeTok{bty =} \StringTok{"n"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{04-monte-carlo_files/figure-pdf/unnamed-chunk-2-1.pdf}}

}

\caption{Empirical vs.~theoretical Var(\hat{\theta}) for g(X)=X\^{}2
with X\textasciitilde N(0,1).}
