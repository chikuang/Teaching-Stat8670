...
Suppose we have a parameter $\theta$ and an estimator $\hat{\theta}$. The mean square error (MSE) of the estimator is defined as $$\mathbb{E}[(\hat{\theta}-\theta )^2 ]= \mathbb{V}ar(\hat{\theta}) + [\mathbb b(\hat{\theta})]^2,$$ where $\mathbb b$ is the bias of the estimator.
:::
